                      ...
                      Shader_group& group)
{
   ...
   for (auto ep_index = 0u; ep_index < count; ++ep_index) {
      ...
      auto vrs_reader = reader.read_child_strict<"VRS_"_mn>();
      ...
      for (auto vari_index = 0u; vari_index < variation_count; ++vari_index) {
         auto vari_reader = reader.read_child_strict<"EP__"_mn>();
                      ...
                      IDirect3DDevice9& device, Shader_database& database)
{
   ...
   read_rendertypes(entrypoints_reader.read_child_strict<"RTS_"_mn>(),
